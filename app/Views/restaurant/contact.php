...
<div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center pt-5 pb-3">
        <h1 class="display-4 text-white animated slideInDown mb-3">Contaco</h1>
...
<div class="container-xxl py-6">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <p class="text-primary text-uppercase mb-2">// Contacto</p>
            <h1 class="display-6 mb-4">Aqui puedes compartirnos tus comentarios, dudas, sugerencias y/o reservar tu restaurante favorito.</h1>
        </div>
            ...
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="subject" placeholder="Motivo">
                                <label for="Motivo">Motivo</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a message here" id="Mensaje" style="height: 200px"></textarea>
